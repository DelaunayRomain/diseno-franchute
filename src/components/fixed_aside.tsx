...
export const FixedAside = () => (
  <aside className='fixed top-0 right-0 h-[100svh] w-15 lg:w-20 bg-black'>
    ...
    <div className='absolute pl-2.5 lg:pl-5 flex flex-col items-center gap-3 bottom-[calc(1.25rem+env(safe-area-inset-bottom))]'>
      <LinkedinLogo />
      <InstagramLogo />
    </div>
  </aside>
