...
export const Gallery = ({ initialState, showAboutText, showGallery }: GalleryProps) => {
  ...
  return images.length > 0 && (
    <div className='fixed inset-0'>
      <div className='ml-10 sm:ml-15 mr-15 md:mx-20 py-8 h-full overflow-y-auto overscroll-contain scroll-smooth no-scrollbar'>
        <div
          className={cn(
            !initialState && showAboutText && 'animate-gallery-move-left',
            !initialState && showGallery && 'animate-gallery-move-right',
          )}
        >
          <div
